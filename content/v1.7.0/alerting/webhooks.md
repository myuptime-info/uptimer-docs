...
The workspace [alert webhook](/v1.7.0/alerting/slack-alerts/) is just an HTTP `POST` with a
...
[`general.site_url`](/v1.7.0/operating/configuration/); when that is unset the URL reads
