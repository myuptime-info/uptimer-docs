...
[versioned by path](/v1.7.0/reference/rest-api/#two-versions), and the SDK keeps that
...
[`GET /version`](/v1.7.0/reference/rest-api/#get-the-server-version) is shared by both
...
**New in 1.6.0.** A [subject](/v1.7.0/core-concepts/signals-and-rules/) is one thing a
...
[`/v2/subjects/{subject}/signals`](/v1.7.0/reference/rest-api/#custom-signals) and
[`/v2/subjects/{subject}/rules`](/v1.7.0/reference/rest-api/#custom-rules) — add them
...
[signal](/v1.7.0/core-concepts/signals-and-rules/) of a Custom subject. The two slugs are
...
Assign [locations](/v1.7.0/core-concepts/locations/) with the `locations` field. It takes
...
- `DefaultUptimerApiError` — the API returned an `error` envelope. Carries `.code`,
  ...
  than `.error_type` (see [Errors](/v1.7.0/reference/rest-api/#errors)).
