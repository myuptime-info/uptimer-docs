...
Full details in the [REST API reference](/v1.7.0/reference/rest-api/).

## Next

Dev mode is for trying, not for running. When you're ready:

- [Core concepts](/v1.7.0/core-concepts/monitors-and-incidents/) — what you're actually configuring.
- [Self-hosting](/v1.7.0/getting-started/self-hosting/) — grow this into a real deployment.
