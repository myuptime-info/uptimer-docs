...
| | **Website** | **Custom** |
|---|---|---|
| Created by | **Add Website check**, or [`POST /v2/monitoring/websites`](/v1.7.0/reference/rest-api/#create-a-website-monitor) | **Add Custom check**, or [`POST /v2/subjects`](/v1.7.0/reference/rest-api/#create-a-custom-subject) |
...
| Data comes from | Uptimer's workers | You, over [the API](/v1.7.0/reference/rest-api/#report-an-observation) |
| Its API | [`/v1/rules`](/v1.7.0/reference/rest-api/#list-rules) and the [`/v2/monitoring/websites`](/v1.7.0/reference/rest-api/#list-website-monitors) alias | [`/v2/subjects`](/v1.7.0/reference/rest-api/#list-custom-subjects) and everything nested under it |
...
screens you can do there too — see the [REST API](/v1.7.0/reference/rest-api/#custom-signals).
...
[`POST /v2/subjects/{subject}/signals`](/v1.7.0/reference/rest-api/#create-a-signal).
...
observations](/v1.7.0/reference/rest-api/#report-an-observation).
...
- [Report an observation](/v1.7.0/reference/rest-api/#report-an-observation) — the API and a
  runnable curl.
- [Python SDK](/v1.7.0/reference/python-sdk/#reporting-observations) — the same call, typed.
- [Monitors & incidents](/v1.7.0/core-concepts/monitors-and-incidents/) — how a verdict becomes
