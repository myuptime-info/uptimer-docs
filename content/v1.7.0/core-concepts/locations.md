...
with a [remote worker](/v1.7.0/core-concepts/remote-workers/). Each location is served by one or
...
over the [REST API](/v1.7.0/reference/rest-api/) and [Python SDK](/v1.7.0/reference/python-sdk/).

> **What each surface calls it.** The dashboard, [API v2](/v1.7.0/reference/rest-api/) and the
...
> working. Workspace [export/import](/v1.7.0/core-concepts/workspaces/#export--import) also keeps
...
> UI, over the [REST API](/v1.7.0/reference/rest-api/), and via
> [import](/v1.7.0/core-concepts/workspaces/#export--import).
