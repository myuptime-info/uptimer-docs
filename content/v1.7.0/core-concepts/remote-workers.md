...
back over gRPC. Running one elsewhere adds a [location](/v1.7.0/core-concepts/locations/) you
...
the production topology is on the [Production deployment](/v1.7.0/operating/production/) page.
