...
`docker compose up`. See [Persistent storage](/v1.5.0/operating/storage/) for what lives in
...
[Authentication → Keycloak](/v1.5.0/operating/authentication/#example-keycloak).
...
[Production deployment](/v1.5.0/operating/production/) page.
