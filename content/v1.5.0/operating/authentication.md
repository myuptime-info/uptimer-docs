...
[`examples/1.5.0/keycloak`](https://github.com/myuptime-info/uptimer-docs/tree/main/examples/1.5.0/keycloak)):
...
[`examples/1.5.0/http-auth`](https://github.com/myuptime-info/uptimer-docs/tree/main/examples/1.5.0/http-auth).
