...
1. Set [`general.site_url`](/v1.6.0/operating/configuration/) to your instance's public base URL,
...
- **The location count is the useful part.** "2 of 3" separates a real outage from one bad
  ...
  [locations](/v1.6.0/core-concepts/locations/) at all. A monitor with a single location omits
...
[Webhooks](/v1.6.0/alerting/webhooks/).
...
- **No Data confirms and alerts too.** A monitor with no
  [location](/v1.6.0/core-concepts/locations/) assigned cannot be decided, so it settles on No
