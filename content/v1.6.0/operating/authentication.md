...
[`examples/1.6.0/keycloak`](https://github.com/myuptime-info/uptimer-docs/tree/main/examples/1.6.0/keycloak)):
...
[REST API reference](/v1.6.0/reference/rest-api/).
...
[`examples/1.6.0/http-auth`](https://github.com/myuptime-info/uptimer-docs/tree/main/examples/1.6.0/http-auth).
