...
`docker compose up`. See [Persistent storage](/v1.6.0/operating/storage/) for what lives in
...
[`examples/1.6.0/persistent`](https://github.com/myuptime-info/uptimer-docs/tree/main/examples/1.6.0/persistent).
...
[Authentication → Keycloak](/v1.6.0/operating/authentication/#example-keycloak).
...
[Production deployment](/v1.6.0/operating/production/) page.
