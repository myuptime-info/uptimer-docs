...
- **A database** — SQLite needs nothing extra; PostgreSQL is recommended for production.
  See [Choosing a database](/v1.6.0/operating/configuration/#choosing-a-database).
...
- [Remote workers](/v1.6.0/core-concepts/remote-workers/) connect to the server over **gRPC** on
