...
[alert webhook](/v1.6.0/alerting/slack-alerts/). Every monitor belongs to one workspace, and
...
in 1.5.0 (the dashboard and [API v2](/v1.6.0/reference/rest-api/) say *locations*). Import it from **Workspace → Import**.
