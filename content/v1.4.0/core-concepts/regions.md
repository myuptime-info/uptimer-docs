...
with a [remote worker](/v1.4.0/core-concepts/remote-workers/). Each region is served by one or
more workers.

Manage regions in the dashboard. Assign a rule to specific regions from the dashboard, or over the
[REST API](/v1.4.0/reference/rest-api/) and [Python SDK](/v1.4.0/reference/python-sdk/) with the
...
> [REST API](/v1.4.0/reference/rest-api/), and via
