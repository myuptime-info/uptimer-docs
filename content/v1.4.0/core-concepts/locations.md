...
with a [remote worker](/v1.4.0/core-concepts/remote-workers/). Each location is served by one or
...
over the [REST API](/v1.4.0/reference/rest-api/) and [Python SDK](/v1.4.0/reference/python-sdk/).
...
> UI, over the [REST API](/v1.4.0/reference/rest-api/), and via
> [import](/v1.4.0/core-concepts/workspaces/#export--import).
...
[How many locations must fail](/v1.4.0/core-concepts/monitors-and-incidents/#how-many-locations-must-fail).
